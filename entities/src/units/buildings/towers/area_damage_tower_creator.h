...
class AreaDamageTowerCreator : public TowerCreator {
   private:
    int level_;
    size_t max_level_;
   ...
   public:
    AreaDamageTowerCreator(int level, size_t max_level,
    ...
    std::shared_ptr<Tower> createTower(unsigned int current_time, Coordinate position) const override;
